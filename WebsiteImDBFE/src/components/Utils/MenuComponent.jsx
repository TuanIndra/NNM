...
const MenuComponent = ({ onClose }) => {
  return (
    <motion.div
      ...
      className="fixed top-0 left-0 w-full h-screen bg-black bg-opacity-95 text-white flex flex-col p-10 z-[1000]" // Tăng z-index để chắc chắn nằm trên cùng
    >
      ...
      {/* Menu Items */}
      <div className="grid grid-cols-3 gap-8 overflow-y-auto flex-1 scrollbar-hide"> {/* Ẩn thanh cuộn mặc định */}
