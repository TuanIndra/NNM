...
const Banner = () => {
    ...
    const fetchLatestMovies = async () => {
      try {
        ...
        const sortedMovies = data
          ...
          .map(movie => ({
            _id: movie._id,
            bannerImage: movie.bannerImage || 'https://via.placeholder.com/1200x500',
            poster: movie.poster || 'https://via.placeholder.com/150x200',
            title: movie.title,
          }));
  ...
  const handlePrev = (e) => {
    e.stopPropagation(); // Ngăn sự kiện lan tỏa lên banner cha
  ...
  return (
    <div className="relative w-full flex justify-center">
      ...
      {/* Thẻ chứa icon và chữ - Gắn điều hướng vào đây */}
      <div
        ...
        onClick={handleNavigateToDetail} // Điều hướng chỉ áp dụng cho khu vực này
      >
        <img
